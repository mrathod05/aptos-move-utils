...
module dev::utils_tests {
    ...
    public fun test_vector_utilities() {
        ...
        assert!(*reverse_vec.borrow(0) == 40, 15);
        assert!(*reverse_vec.borrow(3) == 10, 16);
        utils::print_debug(b"First after reverse", *reverse_vec.borrow(0));
    }
    ...
    public fun test_vector_creation() {
        ...
        assert!(*range_vec.borrow(0) == 1, 18);
        assert!(*range_vec.borrow(3) == 4, 19);
        ...
        assert!(*repeat_vec.borrow(0) == 42, 21);
        assert!(*repeat_vec.borrow(2) == 42, 22);
    ...
    public fun test_comprehensive_example() {
        ...
        transaction_amounts.push_back(100);
        transaction_amounts.push_back(250);
        transaction_amounts.push_back(50);
        ...
        while (i < utils::size(&transaction_amounts)) {
            total_transactions += *transaction_amounts.borrow(i);
            i += 1;
        };
        ...
        let j = 0;
        while (j < 5) {
            powers_of_2.push_back(utils::pow_u64(2, j));
            j += 1;
        };
